		...
		<div id="nav-links">
			<div id="links">
				<a href="RestaurantController?action=addbranch">Add Branch</a> <br></br> <a
					href="RestaurantController?action=addCuisine">AddCuisine</a> <br> <br> <a
					href="RestaurantController?action=addRecipe">Add Recipe</a><br> <br> <br> 
					
				<a href="RestaurantController?action=viewbranch">View Branches</a><br> <br> <br>
				<a href="RestaurantController?action=viewrecipe">View Recipes</a>
			</div>
